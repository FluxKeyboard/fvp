...
class NativeLibrary {
  ...
  late final _MDK_javaVMPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>>('MDK_javaVM');
  late final _MDK_javaVM = _MDK_javaVMPtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>)>();

  void MDK_setLogLevel(int value) {
    return _MDK_setLogLevel(value);
  }

  late final _MDK_setLogLevelPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int32)>>(
    'MDK_setLogLevel',
  );
  late final _MDK_setLogLevel = _MDK_setLogLevelPtr.asFunction<void Function(int)>();

  int MDK_logLevel() {
    return _MDK_logLevel();
  }

  late final _MDK_logLevelPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('MDK_logLevel');
  ...
  late final _MDK_setLogHandlerPtr = _lookup<ffi.NativeFunction<ffi.Void Function(mdkLogHandler)>>(
    'MDK_setLogHandler',
  );
  late final _MDK_setLogHandler = _MDK_setLogHandlerPtr.asFunction<void Function(mdkLogHandler)>();
  ...
  late final _MDK_setGlobalOptionStringPtr =
  ...
  late final _MDK_setGlobalOptionString =
      _MDK_setGlobalOptionStringPtr.asFunction<void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();

  void MDK_setGlobalOptionInt32(ffi.Pointer<ffi.Char> key, int value) {
    return _MDK_setGlobalOptionInt32(key, value);
  }

  late final _MDK_setGlobalOptionInt32Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>>('MDK_setGlobalOptionInt32');
  late final _MDK_setGlobalOptionInt32 =
      _MDK_setGlobalOptionInt32Ptr.asFunction<void Function(ffi.Pointer<ffi.Char>, int)>();

  void MDK_setGlobalOptionFloat(ffi.Pointer<ffi.Char> key, double value) {
    return _MDK_setGlobalOptionFloat(key, value);
  }

  late final _MDK_setGlobalOptionFloatPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Float)>>('MDK_setGlobalOptionFloat');
  late final _MDK_setGlobalOptionFloat =
      _MDK_setGlobalOptionFloatPtr.asFunction<void Function(ffi.Pointer<ffi.Char>, double)>();
  ...
  late final _MDK_setGlobalOptionPtrPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Void>)>>(
          'MDK_setGlobalOptionPtr');
  late final _MDK_setGlobalOptionPtr =
      _MDK_setGlobalOptionPtrPtr.asFunction<void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Void>)>();
  ...
  late final _MDK_getGlobalOptionString = _MDK_getGlobalOptionStringPtr.asFunction<
  ...
  late final _MDK_getGlobalOptionInt32Ptr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Int>)>>(
          'MDK_getGlobalOptionInt32');
  late final _MDK_getGlobalOptionInt32 =
      _MDK_getGlobalOptionInt32Ptr.asFunction<bool Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Int>)>();
  ...
  late final _MDK_getGlobalOptionPtr =
      _MDK_getGlobalOptionPtrPtr.asFunction<bool Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<ffi.Void>>)>();

  ffi.Pointer<ffi.Char> MDK_strdup(ffi.Pointer<ffi.Char> strSource) {
    return _MDK_strdup(strSource);
  }

  late final _MDK_strdupPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>>('MDK_strdup');
  late final _MDK_strdup = _MDK_strdupPtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
  ...
  late final _MDK_AudioStreamCodecParameters = _MDK_AudioStreamCodecParametersPtr.asFunction<
      void Function(
        ffi.Pointer<mdkAudioStreamInfo>,
        ffi.Pointer<mdkAudioCodecParameters>,
      )>();
  ...
  late final _MDK_VideoStreamCodecParameters = _MDK_VideoStreamCodecParametersPtr.asFunction<
      void Function(
        ffi.Pointer<mdkVideoStreamInfo>,
        ffi.Pointer<mdkVideoCodecParameters>,
      )>();
  ...
  late final _MDK_SubtitleStreamCodecParameters = _MDK_SubtitleStreamCodecParametersPtr.asFunction<
      void Function(
        ffi.Pointer<mdkSubtitleStreamInfo>,
        ffi.Pointer<mdkSubtitleCodecParameters>,
      )>();
  ...
  late final _MDK_SubtitleStreamMetadata = _MDK_SubtitleStreamMetadataPtr.asFunction<
      bool Function(
        ffi.Pointer<mdkSubtitleStreamInfo>,
        ffi.Pointer<mdkStringMapEntry>,
      )>();
  ...
  late final _MDK_MediaMetadata =
      _MDK_MediaMetadataPtr.asFunction<bool Function(ffi.Pointer<mdkMediaInfo>, ffi.Pointer<mdkStringMapEntry>)>();
  ...
  late final _mdkVideoFrameAPI_newPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<mdkVideoFrameAPI> Function(ffi.Int, ffi.Int, ffi.Int32)>>(
          'mdkVideoFrameAPI_new');
  late final _mdkVideoFrameAPI_new =
      _mdkVideoFrameAPI_newPtr.asFunction<ffi.Pointer<mdkVideoFrameAPI> Function(int, int, int)>();
  ...
  late final _mdkVideoFrameAPI_deletePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Pointer<mdkVideoFrameAPI>>)>>(
          'mdkVideoFrameAPI_delete');
  late final _mdkVideoFrameAPI_delete =
      _mdkVideoFrameAPI_deletePtr.asFunction<void Function(ffi.Pointer<ffi.Pointer<mdkVideoFrameAPI>>)>();
  ...
  late final _mdkVideoBufferPoolFreePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Pointer<mdkVideoBufferPool>>)>>(
          'mdkVideoBufferPoolFree');
  late final _mdkVideoBufferPoolFree =
      _mdkVideoBufferPoolFreePtr.asFunction<void Function(ffi.Pointer<ffi.Pointer<mdkVideoBufferPool>>)>();

  ffi.Pointer<mdkPlayerAPI> mdkPlayerAPI_new() {
    return _mdkPlayerAPI_new();
  }

  late final _mdkPlayerAPI_newPtr = _lookup<ffi.NativeFunction<ffi.Pointer<mdkPlayerAPI> Function()>>(
    'mdkPlayerAPI_new',
  );
  late final _mdkPlayerAPI_new = _mdkPlayerAPI_newPtr.asFunction<ffi.Pointer<mdkPlayerAPI> Function()>();

  void mdkPlayerAPI_delete(ffi.Pointer<ffi.Pointer<mdkPlayerAPI>> arg0) {
    return _mdkPlayerAPI_delete(arg0);
  }

  late final _mdkPlayerAPI_deletePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Pointer<mdkPlayerAPI>>)>>('mdkPlayerAPI_delete');
  late final _mdkPlayerAPI_delete =
      _mdkPlayerAPI_deletePtr.asFunction<void Function(ffi.Pointer<ffi.Pointer<mdkPlayerAPI>>)>();
  ...
  late final _mdkPlayerAPI_resetPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Pointer<mdkPlayerAPI>>, ffi.Bool)>>(
          'mdkPlayerAPI_reset');
  late final _mdkPlayerAPI_reset =
      _mdkPlayerAPI_resetPtr.asFunction<void Function(ffi.Pointer<ffi.Pointer<mdkPlayerAPI>>, bool)>();

  void MDK_foreignGLContextDestroyed() {
    return _MDK_foreignGLContextDestroyed();
  }

  late final _MDK_foreignGLContextDestroyedPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>(
    'MDK_foreignGLContextDestroyed',
  );
  late final _MDK_foreignGLContextDestroyed = _MDK_foreignGLContextDestroyedPtr.asFunction<void Function()>();
}
...
final class mdkMediaStatusChangedCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Int32, ffi.Pointer<ffi.Void>)>> cb;
...
final class mdkStateChangedCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int32, ffi.Pointer<ffi.Void>)>> cb;
...
final class mdkLogHandler extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int32, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Void>)>>
      cb;
...
final class mdkVideoFrameAPI extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mdkVideoFrame>)>> planeCount;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mdkVideoFrame>, ffi.Int)>> width;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mdkVideoFrame>, ffi.Int)>> height;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<mdkVideoFrame>)>> format;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Bool Function(
            ...
            ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Pointer<ffi.Void>>)>>,
            ffi.Int,
          )>> addBuffer;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Uint8> Function(ffi.Pointer<mdkVideoFrame>, ffi.Int)>>
      bufferData;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mdkVideoFrame>, ffi.Int)>> bytesPerLine;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkVideoFrame>, ffi.Double)>> setTimestamp;

  external ffi.Pointer<ffi.NativeFunction<ffi.Double Function(ffi.Pointer<mdkVideoFrame>)>> timestamp;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Pointer<mdkVideoFrameAPI> Function(ffi.Pointer<mdkVideoFrame>)>>
      onDestroy;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<mdkVideoFrame>)>> toHost;
...
final class mdkCurrentMediaChangedCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> opaque)>> cb;
...
final class mdkSeekCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int64 ms, ffi.Pointer<ffi.Void> opaque)>> cb;
...
final class mdkTimeoutCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Int64 ms, ffi.Pointer<ffi.Void> opaque)>> cb;
...
final class mdkMediaEventCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<mdkMediaEvent>, ffi.Pointer<ffi.Void>)>> cb;

  external ffi.Pointer<ffi.Void> opaque;
}

final class mdkLoopCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int, ffi.Pointer<ffi.Void>)>> cb;
...
final class mdkSyncCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Double Function(ffi.Pointer<ffi.Void> opaque)>> cb;
...
final class mdkPlayerAPI extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Bool)>> setMute;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Float)>> setVolume;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Pointer<ffi.Char>)>> setMedia;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<mdkPlayer>)>> url;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Bool)>> setPreloadImmediately;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, mdkCurrentMediaChangedCallback)>>
      currentMediaChanged;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int64, mdkTimeoutCallback)>>
      setTimeout;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Pointer<mdkMediaInfo> Function(ffi.Pointer<mdkPlayer>)>> mediaInfo;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int32)>> setState;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<mdkPlayer>)>> state;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, mdkStateChangedCallback)>>
      onStateChanged;

  external ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<mdkPlayer>, ffi.Int32, ffi.Long)>> waitFor;

  external ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<mdkPlayer>)>> mediaStatus;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, mdkMediaStatusChangedCallback)>>
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int, ffi.Int)>> resizeSurface;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>)>> showSurface;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int, ffi.Pointer<ffi.Void>)>>
      rotate;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Double Function(ffi.Pointer<mdkPlayer>, ffi.Pointer<ffi.Void>)>>
      renderVideo;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, mdkRenderCallback)>>
      setRenderCallback;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, mdkVideoCallback)>> onVideo;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>)>> onAudio;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<mdkPlayer>)>> position;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<mdkPlayer>, ffi.Int64, mdkSeekCallback)>> seek;

  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Float)>> setPlaybackRate;

  external ffi.Pointer<ffi.NativeFunction<ffi.Float Function(ffi.Pointer<mdkPlayer>)>> playbackRate;

  /// !
  /// \brief buffered
  /// get buffered data(packets) duration and size
  /// \return buffered data duration
  external ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<mdkPlayer>, ffi.Pointer<ffi.Int64>)>> buffered;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int64, ffi.Int64, ffi.Bool)>>
      setBufferRange;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int, ffi.Int64, ffi.Int64)>>
      setLoopRange;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int)>> setLoop;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Int64, ffi.Int64)>> setRange;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, mdkSyncCallback, ffi.Int)>> onSync;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Float, ffi.Int)>>
      setChannelVolume;
  ...
  /// - <0: render ASAP.
  /// - >0: target frame rate
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<mdkPlayer>, ffi.Float)>> setFrameRate;
  ...
  external ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<mdkPlayer>, ffi.Pointer<ffi.Int64>, ffi.Int)>>
      bufferedTimeRanges;
...
final class SwitchBitrateCallback extends ffi.Struct {
  external ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Bool, ffi.Pointer<ffi.Void>)>> cb;
